...
st.markdown("<center><h3><p style='color: yellow;'>Select from the dimensions shown in the following list:</p></h3></center>", unsafe_allow_html=True)
st.markdown("<center><h4><p style='color: yellow;'>Wählen Sie aus den in der folgenden Liste angezeigten Dimensionen:</p></h4></center>", unsafe_allow_html=True)
